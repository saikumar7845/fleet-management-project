...
router.get('/', async (req, res) => {
  try {
    ...
    res.json({ counts: { vehicles: 0, drivers: 0, trips: 0, dueMaintenance: 0 }, totalDistance: 0, totalFuel: 0, totalMaintenanceCost: 0, utilization: 0, byVehicle: [], dueMaintenance: [] });
  }
});
